// Created a table of 512 entries for sine that can be used to derive sine and cosine with fixed point values. By shifting for cosine and sine offsets we can actually just use 1 array as well.
// I used the example from the TONC website to create this array file.
